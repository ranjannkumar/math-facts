...
const PretestResultScreen = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="mx-auto mb-4 sm:mb-6 rounded-xl px-5 py-3 sm:px-8 sm:py-3 celebration-animation"
          style={{
            maxWidth: 520,
            background: 'linear-gradient(90deg, #8BEC98 0%, #FFB703 100%)',
            boxShadow: '0 8px 24px rgba(0,0,0,.12)',
          }}
        >
          <h2
            className="m-0 text-xl sm:text-2xl md:text-3xl font-extrabold tracking-wide truncate"
            style={{ letterSpacing: '0.06em', color: '#273444' }}
            title={passed ? 'CONGRATULATONS' : 'WAY TO GO'}
          >
            {passed ? 'CONGRATULATONS' : 'WAY TO GO'}
          </h2>
        </div>
        ...
        {passed ? (
          ...
          <div className="bg-blue-100/70 border-2 border-green-300 rounded-2xl py-2 sm:py-6 px-2 mb-6 sm:mb-8 mx-auto max-w-md w-full shadow-lg">
            <p className="text-green-700 font-extrabold text-2xl sm:text-3xl md:text-4xl">
               Earn your belts 
            </p>
          </div>
